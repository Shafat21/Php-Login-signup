                ...
                <div class="content-center">
                    <div class="container">
                        <div class="title-brand">
                            <h1 class="presentation-title">PHP Login and Sign Up</h1>
                            <div class="fog-low">
                        ...
                        <h2 class="presentation-subtitle text-center">By Shafat Alam</h2>
                        <h2 class="presentation-subtitle text-center">213-134-001</h2>
                    </div>
                </div>
